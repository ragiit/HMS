...
// JWT Authentication menggunakan opsi dari Shared.Security
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "HMS Identity API", Version = "v1" });
...
// Apply database migrations & seed (idempoten)
